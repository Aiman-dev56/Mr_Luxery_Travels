...
export default function Hero() {
    return (
        <div>
            <section className=" flex justify-center  2xl:h-[100vh] lg:h-[90vh] md:h-[80vh]  h-[50vh] mb-10 w-full overflow-hidden">
                <div className="relative w-[98%]  ">
                    ...
                    {/* Your content here */}
                    <div className="relative z-20 flex flex-col w-[80%] md:w-[80%] sm:w-[80%] lg:w-[50%] 2xl:w-[60%] py-2 px-4 justify-start 2xl:top-[200px] lg:top-[180px] left-[20px] md:top-[100px]  top-[10px]">
