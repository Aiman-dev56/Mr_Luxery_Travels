...
export default function NewsSec() {
    return (
        <section className="container  ">
            <div className="2xl:w-[940px] lg:w-[800px] md:w-[600px] w-[200px] m-8 mt-20">
                <Typography variant="h2"> Latest News</Typography>
                <Typography variant="p" className="2xl:w-[950px] lg:w-160 md:w-100 w-64">For stories, seasonal moments, and a glimpse into the world of MRLUXURYTRAVELSfollow @MRLUXURYTRAVELS on Instagram.</Typography>
            </div>
            <div className="m-6">
                <div className="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 lg:gap-2 gap-2 ">
                    <div className="flex flex-col">
                        <div className="2xl:w-[400px] 2xl:h-[320px] lg:w-[300px] lg:h-[200px] md:w-[250px] md:h-[170px] sm:w-[200px] ">
                            <ImageComp src={Images.NewsImg}
                                className="object-cover 2xl:w-[400px] 2xl:h-[300px] lg:w-[280px] lg:h-[190px] md:w-[250px] md:h-[170px] sm:w-[200px] w-[180px] h-[112px] rounded-lg " />
                        </div>
                        <div className="mt-2 2xl:w-[400px] md:w-[250px] md:h-[170px] sm:w-[200px]">
